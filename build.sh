...
make -j4 release APP_DIR="apps/climate-monitor" EXTRA_CFLAGS="-D'USE_BATTERY_FORMAT_STANDARD' -D'USE_HUMIDITY_TAG'" OUT=bcf-climate-monitor-tags-$VERSION VERSION=$VERSION
